...
{
  class WebSiteLinkService : Service<Domain.Entity.WebSiteLink>, IWebSiteLinkService
  {
    public WebSiteLinkService(IRepositoryAsync<WebSiteLink> repository) : base(repository)
    {
    }
  }
}
