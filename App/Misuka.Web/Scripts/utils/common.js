...
var common = new function () {
    ...
    this.setNavigationMenuBackEnd = function () {
        ...
        var flag = false;
        if (path.indexOf('/Asset/PersonAsset') != -1) {
            path = "/Asset/PersonAsset";
        }
        else if (path.indexOf('/PersonDocument') != -1) {
            path = "/PersonDocument";
        }
        ...
        if (path.indexOf('MeetingRoom') != -1) {
            path = "/MeetingRoom";
        }
        if (path.indexOf('Booking') != -1) {
            path = "/Booking";
        }
        if (path.indexOf('/PurchaseRequest/Evaluate') != -1) {
            path = "/PurchaseRequest/Evaluate";
        }
        else if (path.indexOf('/PurchaseRequest/EditEvaluate') != -1) {
            path = "/PurchaseRequest/Evaluate";
        }
        else if (path.indexOf('/PurchaseRequest/Approve') != -1) {
            path = "/PurchaseRequest/Approve";
        }
        else if (path.indexOf('/PurchaseRequest/EditApprove') != -1) {
            path = "/PurchaseRequest/Approve";
        }
        else if (path.indexOf('/PurchaseRequest') != -1) {
            path = "/PurchaseRequest";
        }
        if (path.indexOf('/Asset/PersonAsset') != -1) {
            path = "/Asset/PersonAsset";
        }
        else if (path.indexOf('/Asset/AssetAssign') != -1) {
            path = "/Asset/PersonAsset";
        }
        else if (path.indexOf('/AssetType') != -1) {
            path = "/AssetType";
        }
        else if (path.indexOf('Asset') != -1) {
            path = "/Asset";
        }
        if (path.indexOf('/FolderFile/Approve') != -1) {
        ...
        if (path.indexOf('/Leave/Approval') != -1) {
            path = path + window.location.search;
            flag = true;
        }
        else if (path.indexOf('LeaveType') != -1) {
            path = "/LeaveType";
        }
        else if (path.indexOf('AnnualLeave') != -1) {
            path = "/AnnualLeave";
        }
        else if (path.indexOf('LeaveTransfer') != -1) {
            path = "/LeaveTransfer";
        }
        else if (path.indexOf('Leave') != -1) {
            path = "/Leave";
        }
        if (path.indexOf('ListNewsFeed') != -1) {
            path = path + window.location.search;
            flag = true;
        }
        else if (path.indexOf('NewsFeedType') != -1) {
            path = "/NewsFeedType";
        }
        else if (path.indexOf('NewsFeed') != -1) {
            path = "/NewsFeed";
        }
        if (path.indexOf('/Skill/Approve') != -1) {
            path = path + window.location.search;
            flag = true;
        }
        else if (path.indexOf('Skill') != -1) {
            path = "/Skill";
        }
        if (path.indexOf('/Poll/EditPoll') != -1) {
            path = "/Poll";
        }
        else if (path.indexOf('/Poll/Edit') != -1) {
            path = "/Poll/Schedule";
        }
    
        else if (path.indexOf('/Poll/Schedule') != -1) {
            path = "/Poll/Schedule";
        }
        ...
        $(".treeview-menu a").each(function () {
            ...
            if (href == "/NewsFeed" && path == "/NewsFeedType") {
                href = "none";
            }
            if (href == "/Leave" && path == "/LeaveType") {
                href = "none";
            }
            if (href == "/Asset" && path == "/AssetType") {
                href = "none";
            }
            if (href == "/Asset" && path == "/Asset/PersonAsset") {
                href = "none";
            }
            if (href == "/Person" && path == "/PersonDocument") {
                href = "none";
            }
            if (href == "/Poll" && path == "/Poll/Schedule") {
                href = "none";
            }
            if (href == "/PurchaseRequest" && (path == "/PurchaseRequest/Approve" || path == "/PurchaseRequest/EditApprove")) {
                href = "none";
            }
            if (href == "/PurchaseRequest" && (path == "/PurchaseRequest/EditEvaluate" || path == "/PurchaseRequest/Evaluate")) {
                href = "none";
            }
    ...
    this.setNavigationMenuProject = function () {
        var path = window.location.pathname;
        ...
        var flag = false;
         ...
         if (path.indexOf('ProjectItem') != -1 && flag == false) {
             path = "/ProjectItem";
         }
         $("#side-menu a").each(function () {
             var href = $(this).attr('href');
             if (href == "/Project" && path == "/ProjectItem") {
                 href = "none";
            }
            if (flag) {
                if (path == href) {
            ...
            //else {
            //    if (path.length >= href.length && href != "none") {
            //        if (path.substring(0, href.length) === href) {
            //            $(this).closest('li').addClass('active');
            //            $(this).closest('ul').addClass('in');
            //            $(this).parent().parent().parent().closest('li').addClass('active');
    ...
    this.setNavigationMenuFrontEnd = function () {
        ...
        if (path.indexOf('/Person/EditProfile') != -1) {
            path = path + window.location.search;
            flag = true;
        }
        else if (path.indexOf('/PersonDocument') != -1) {
        ...
        else if (path.indexOf('Leave/Schedule') != -1) {
            path = "/Leave/Schedule";
        }
        else if (path.indexOf('Leave') != -1) {
            path = "/Leave";
        ...
        if (path.indexOf('/Skill/Approve') != -1) {
         ...
         $(".c-menu-type-classic a").each(function () {
            ...
            if (href == "/Leave" && path == "/Leave/Schedule") {
                href = "none";
            }
            if (href == "/Person" && path == "/PersonDocument") {
                href = "none";
