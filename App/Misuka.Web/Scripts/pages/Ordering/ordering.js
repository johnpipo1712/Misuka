var OrderClient = new function () {
    ...
    this.ReloadGrid = function () {
        $("#OrderGrid").jqGrid().setGridParam({
            url: "/Order/GetOrders?keyword=" + $("#Keyword").val(),
            page: 1
        });
            ...
            colModel: [
                ...
                { name: 'Price', index: 'Price', editable: false }, {
                    name: 'Action', cellattr: function () { return ' title=""'; }, formatter: function (cellvalue, options, rowObject) {
                        var html = '';
                        html += '<a data-toggle="tooltip" data-placement="left" title="Edit" onclick="OrderClient.ShowEdit(\'' + options.rowId + '\')" href="javascript:;"><img src="/Content/img/common/grid/edit_command.gif" class="edit_command"/></a>';
